...
var mapboxToken = window.MAPBOX_PUBLIC_TOKEN || '';
var mapboxTilesUrl = 'https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=' + mapboxToken;

L.tileLayer(mapboxTilesUrl, {
    maxZoom: 18,
